...
def handler_point_bonus(booking_order, amount, is_secure, system_name="metiz_online"):
    params = {
...
def handler_confirm_booking_success(request, booking_order, amount):
    ...
    if booking_order.card_member:
        handler_point_bonus(booking_order, amount, request.is_secure(), booking_order.system_name)
